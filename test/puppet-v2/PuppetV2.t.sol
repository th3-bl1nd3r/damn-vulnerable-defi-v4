...
import {PuppetV2Pool, UniswapV2Library} from "../../src/puppet-v2/PuppetV2Pool.sol";
...
contract PuppetV2Challenge is Test {
    ...
    function test_puppetV2() public checkSolvedByPlayer {
        ...
        uniswapV2Router.swapExactTokensForETH(10000 ether, 0, path, player, block.timestamp + 64);
